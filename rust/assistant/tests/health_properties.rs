//! Property-based tests for Assistant SDK health check.
//!
...
use lifesavor_assistant_sdk::health::HealthCheckBuilder;
use lifesavor_assistant_sdk::{HealthCheckConfig, HealthCheckMethod, HealthStatus};
